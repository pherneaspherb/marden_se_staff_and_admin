...
class LaundryOrderStatusTab extends StatefulWidget {
  const LaundryOrderStatusTab({super.key});

  @override
  State<LaundryOrderStatusTab> createState() => _LaundryOrderStatusTabState();
}

class _LaundryOrderStatusTabState extends State<LaundryOrderStatusTab> {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, customerSnapshot) {
        ...
        return StreamBuilder<List<QueryDocumentSnapshot>>(
          stream: _getLaundryOrdersStream(customerSnapshot.data!, status),
          builder: (context, orderSnapshot) {
            if (orderSnapshot.connectionState == ConnectionState.waiting) {
              return const Center(child: CircularProgressIndicator());
            }
            if (!orderSnapshot.hasData || orderSnapshot.data!.isEmpty) {
              return Center(child: Text("No laundry $status orders found."));
            }
